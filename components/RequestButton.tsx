  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1.5 rounded-full border border-white/15 bg-black/50 p-2.5 text-xs font-medium text-white backdrop-blur-md transition hover:bg-black/70 sm:px-3.5 sm:py-1.5"
      >
        <svg
          viewBox="0 0 24 24"
